  ...
  return (
    <section className="w-full h-fit py-4 lg:h-[30rem]">
      <div className="w-wsm mx-auto md:w-wmd md:mx-auto lg:w-wlg lg:mx-auto flex flex-col items-start gap-8">
        ...
        <div className="w-full h-fit grid grid-cols-1 place-items-center gap-4 md:w-full md:grid md:grid-cols-2 md:place-items-center md:gap-5 lg:w-full lg:grid lg:grid-cols-5 lg:place-items-start lg:gap-4">
          ...
          <div className="w-52 h-fit py-2 border border-gray">
            <div className="w-full h-fit px-2">
